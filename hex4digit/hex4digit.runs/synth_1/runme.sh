...
HD_PWD='/home/dpelis/hex4digit/hex4digit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hexcount.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hexcount.tcl
