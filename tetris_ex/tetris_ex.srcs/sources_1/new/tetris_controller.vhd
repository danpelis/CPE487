...
merge <= '1';
 ...
 if (key_left = '1') and (key_right = '0') and
(can_move_left = '1') then
 move_left <= '1';
 elsif (key_left = '0') and (key_right = '1') and
(can_move_right = '1') then
 move_right <= '1';
 end if;

 elsif (key_up_old = '0') and (key_up = '1') and (can_rotate
= '1') then
 rotate <= '1';
