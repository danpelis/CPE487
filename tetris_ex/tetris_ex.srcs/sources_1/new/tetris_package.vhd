...
package TETRIS_PACKAGE is
 ...
 type SHAPE_TYPE is (SHAPE_T, SHAPE_SQUARE, SHAPE_LINE, SHAPE_L_LEFT,
SHAPE_L_RIGHT, SHAPE_Z_LEFT, SHAPE_Z_RIGHT);
 ...
 type BOARD_TILE_MATRIX is array(NATURAL range <>, NATURAL range <>) of
BOARD_TILE_TYPE;
 subtype BOARD_TYPE is BOARD_TILE_MATRIX(0 to (BOARD_WIDTH - 1), 0 to
(BOARD_HEIGHT - 1));
 ...
 (
 shape => SHAPE_T,
 tiles => ((x => 1, y => 1), (x => 0, y =>1), (x => 1, y => 0), (x
=> 2, y => 1))
 );
 ...
 (
 shape => SHAPE_SQUARE,
 tiles => ((x => 1, y => 1), (x => 1, y => 0), (x => 2, y => 0), (x
=> 2, y => 1))
 );
 ...
 (
 shape => SHAPE_LINE,
 tiles => ((x => 1, y => 0), (x => 0, y => 0), (x => 2, y => 0), (x
=> 3, y => 0))
 );
 ...
 (
 shape => SHAPE_L_LEFT,
 tiles => ((x => 1, y => 1), (x => 0, y => 1), (x => 0, y => 0), (x
=> 2, y => 1))
 );
 ...
 (
 shape => SHAPE_L_RIGHT,
 tiles => ((x => 1, y => 1), (x => 0, y => 1), (x => 2, y => 1), (x
=> 2, y => 0))
 );
 ...
 (
 shape => SHAPE_Z_LEFT,
 tiles => ((x => 1, y => 1), (x => 1, y => 0), (x => 0, y => 0), (x
=> 2, y => 1))
 );
...
=> 2, y => 0))
 ...
 function rotate_function (tetrimino : TETRIMINO_TYPE) return
TETRIMINO_TYPE;
 function rotate_border_function (tetrimino : TETRIMINO_TYPE) return
BOOLEAN;
