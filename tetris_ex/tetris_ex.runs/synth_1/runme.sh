...
HD_PWD='C:/Users/dppel/Projects/CPE 487/tetris_ex/tetris_ex.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TETRIS.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TETRIS.tcl
