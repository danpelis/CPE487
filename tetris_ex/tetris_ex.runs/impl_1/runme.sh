...
HD_PWD='C:/Users/dppel/Projects/CPE 487/tetris_ex/tetris_ex.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TETRIS.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TETRIS.tcl -notrace
