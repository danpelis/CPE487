...
HD_PWD='C:/Users/dppel/Projects/CPE 487/Hexcalc/Hexcalc1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hexcalc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hexcalc.tcl
