...
HD_PWD='C:/Users/dppel/Projects/CPE 487/Hexcalc/Hexcalc1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hexcalc.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hexcalc.tcl -notrace
